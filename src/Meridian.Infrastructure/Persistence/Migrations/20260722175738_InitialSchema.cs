        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Country = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    YearsOfExperience = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
                    ...
                    PortfolioUrl = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinYearsExperience = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
                    ...
                    RankingStrategy = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobRequiredSkills_JobPostings_JobPostingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvidenceSnippet = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationEvents_Users_ActorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalendarUid = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationEvents_ActorUserId",
                table: "ApplicationEvents",
                column: "ActorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationEvents_JobApplicationId_OccurredAt",
                table: "ApplicationEvents",
                columns: new[] { "JobApplicationId", "OccurredAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interviews_InterviewerUserId_ScheduledStart",
                table: "Interviews",
                columns: new[] { "InterviewerUserId", "ScheduledStart" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_Status_ClosingDate",
                table: "JobPostings",
                columns: new[] { "Status", "ClosingDate" });

            migrationBuilder.CreateIndex(
                name: "IX_JobRequiredSkills_JobPostingId_SkillId",
